...
<b><p>Note: Support for this is discontinued. I'm now using [Stocks Cafe](https://stocks.cafe/user/tosignup?referral_code=chenningg97) instead. You should check it out! (Disclaimer: This link uses my referral code).</p></b>
